...
- No P0/P1 release findings were reported; M20 is accepted. Any later P2/P3 documentation or
  fixture cleanup is backlog only; UNKNOWN or FAIL in a required release gate is not accepted as
  a pass.
