...
M15R.1 is limited to MotorControl fail-closed Safety Semantic Closure. Its final repository gate is
green and `READY_FOR_M16 = YES` is recorded. M16 ProtocolIR is only the next declared phase; it is
