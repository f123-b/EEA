...
- M19A FOC Minimal E2E final gate closed at HEAD `3b42e69` on `codex/m19-foc-minimal-e2e`, based
  ...
  Draft PR #13 remains OPEN/DRAFT/UNMERGED; final PR CI is `32020845145` and push CI is
  `32020840664`, both green across backend, desktop-web, desktop-tauri, and m19-release.
