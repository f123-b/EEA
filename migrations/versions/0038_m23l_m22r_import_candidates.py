"""M23L landing migration for M22R import candidates and apply conflicts.

This is an additive landing migration.  The integrated development branch used
0036 after the M23 migration, so the M22R landing branch owns a new revision
that follows the M22 migration directly without rewriting either historical
file.
"""
...
revision: str = "0038_m23l_m22r_import_candidates"
