"""M23R landing migration for trusted identity and memory audit closure.

This additive revision follows the M23L landing Knowledge migration.  The
integrated development branch's 0037 revision is preserved there and is not
rewritten or used by the sequential landing chain.
"""
...
revision: str = "0040_m23l_m23r_memory_trust_closure"
down_revision: str | None = "0039_m23l_knowledge_memory"
