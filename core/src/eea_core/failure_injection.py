...
class FailureInjectionPoint(StrEnum):
    ...
    RESTORE_AFTER_STAGE = "restore.after_stage"
    RESTORE_AFTER_PREPARE_COMMIT = "restore.after_prepare_commit"
    RESTORE_AFTER_FS_ACTIVATE = "restore.after_fs_activate"
    RESTORE_BEFORE_DB_FINALIZE = "restore.before_db_finalize"
    RESTORE_AFTER_DB_FINALIZE = "restore.after_db_finalize"
