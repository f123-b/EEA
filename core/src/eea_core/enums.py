...
class AuthorityLevel(StrEnum):
    T0_OFFICIAL = "T0_OFFICIAL"
    T1_VENDOR = "T1_VENDOR"
    T2_MAINTAINER = "T2_MAINTAINER"
    T3_REVIEWED = "T3_REVIEWED"
    T4_PROJECT = "T4_PROJECT"
    T5_USER = "T5_USER"
    T6_AI_INFERENCE = "T6_AI_INFERENCE"
...
class EngineeringErrorCode(StrEnum):
    ...
    ORGANIZATION_SCOPE_UNAVAILABLE = "ORGANIZATION_SCOPE_UNAVAILABLE"
    ...
    PATCH_PROPOSAL_NOT_FOUND = "PATCH_PROPOSAL_NOT_FOUND"
    GENERATED_SOURCE_DIVERGED = "GENERATED_SOURCE_DIVERGED"
    ...
    RENDER_CONTENT_REJECTED = "RENDER_CONTENT_REJECTED"
    NFR_LIMIT_EXCEEDED = "NFR_LIMIT_EXCEEDED"
